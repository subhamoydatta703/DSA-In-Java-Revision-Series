...
This repository is a Java practice workspace for Data Structures and Algorithms. It currently contains 254 Java source files grouped by topic. Most files are standalone `main` classes that can be compiled and run from the repository root.
...
| `backtracking/` | 5 | Backtracking practice for mutating arrays in-place, generating subsets and permutations, and solving the N-Queens placement problem. |
...
- Backtracking on arrays, recursive subset/permutation generation for arrays and strings, and N-Queens board placement
