...
This repository is a Java practice workspace for Data Structures and Algorithms. It currently contains 120 small, focused programs grouped by topic. Most files are standalone `main` classes that can be compiled and run from the repository root.
...
| `revision/` | 44 | Rewritten or revisited versions of common interview problems, currently split into hashmap, sliding-window, and two-pointer revision folders. |
...
- Revision sliding-window problems for fixed-size maximum and minimum subarray sums
