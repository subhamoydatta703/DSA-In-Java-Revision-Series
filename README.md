...
| `linked_list/` | 2 | Basic singly and doubly linked list concepts, including node definition, construction, traversal, insertion, deletion, and previous/next links. |
...
- Linked list node definition, structure creation, traversal, insertion, deletion, and doubly linked list forward/backward navigation
...
- `DoublyLinkedList.java` - demonstrates doubly linked list node creation, previous/next links, and forward/backward traversal helpers.
