...
This repository is a Java practice workspace for Data Structures and Algorithms. It currently contains 263 Java source files grouped by topic. Most files are standalone `main` classes that can be compiled and run from the repository root.
...
| `backtracking/` | 12 | Backtracking practice for mutating arrays in-place, generating subsets and permutations, finding subset and combination sums, palindrome partitioning, and solving the N-Queens placement problem. |
